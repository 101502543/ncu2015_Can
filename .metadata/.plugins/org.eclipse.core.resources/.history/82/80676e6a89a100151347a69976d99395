...
public class testAll {
	...
	public final void testIllegalInputNoInteger() {
		// change integer to num
		UDPUS.judgeCommand("[UPDATE,ItemName,num,OwnerName,num,N,num,num,num]");
	}

	@Test(expected = ArrayIndexOutOfBoundsException.class)
	public final void testIllegalInputWrongStringSize() {
		// change integer to num
		UDPUS.judgeCommand("wrongMessage");
	}
